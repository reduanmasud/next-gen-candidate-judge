...
export default function QuizProgressModal({ open, result, taskScore }: QuizProgressModalProps) {
    ...
    useEffect(() => {
        ...
        const evaluateNextQuestion = () => {
            ...
            // After 500ms, mark as completed and move to next
            setTimeout(() => {
                setQuestionStatuses(prev => {
                    const newMap = new Map(prev);
                                        ...
                                        >
                                            <div className="relative h-5 w-5 flex-shrink-0">
                                                {status === 'evaluating' ? (
                                                    ...
                                                    <XCircle className="absolute inset-0 h-5 w-5 text-red-500 animate-in fade-in duration-300" />
                                                )}
                                            </div>
                                            <span
                                ...
                                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                                    <div className="flex justify-center items-center gap-2">
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            ...
                                            <span className="font-semibold text-foreground">{result.total_count}</span> questions correct
                                        </p>
                                    </div>
                                </div>
